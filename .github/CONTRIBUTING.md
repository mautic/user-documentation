...
Say you need to update the documentation for version `6.0`. By mistake, you create a new branch from branch `7.0` and work on this branch. Or you correctly apply your changes based on branch `6.0`, but when you create the PR, you forgot to set the base branch to `6.0`.
