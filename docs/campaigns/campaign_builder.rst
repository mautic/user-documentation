...
.. list-table:: Campaign Actions in Mautic
   ...
   * - **Send Email**   
     ...
     - Emails can be transactional or marketing. Marketing emails will obey Email Channel's Do Not Contact setting of the contact, Transactional Emails will disregard the Do Not Contact value. This allows to send Transactional emails as campaign step to Contacts even if they opted out to recieve Marketing emails via standard unsubscribe action and have DNC set as 'no'.
   * - **Send Email to User** 
