...
.. note::
  ...
  Hour-based relative filters work with datetime fields such as **Date last active** or **Date modified**. These filters compare the full timestamp including time, not just the date portion.
