...
* **From the Project** - Open a Project and select 'Add new to project'. Choose the type of item you want to add, then select the items from the list. You can add an optional note to describe the assignment. To detach an item, select 'Remove from project' next to it.
