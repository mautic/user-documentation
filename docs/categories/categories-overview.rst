...
Categories are a way to organize Mautic elements. They're available for Assets, Campaigns, Emails, Focus Items, Forms, Pages, Points and Stages. There are two ways to use Categories:
...
Deleting a Category doesn't delete the items assigned to it. Those associated items, for example, Assets, Campaigns, Emails, and Forms, remain in Mautic and become uncategorized. This applies both when you delete a single Category and when you batch delete multiple Categories.
