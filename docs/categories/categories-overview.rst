...
Categories are a way to organize Mautic elements. They're available for Assets, Campaigns, Emails, focus items, Forms, Landing Pages, Points, social monitoring and Stages. There are two ways to use Categories:
