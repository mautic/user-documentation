...
.. tip:: Custom Company fields

   The syntax for custom Company fields is different than the core Company field syntax. You must **not** add the word "Company" in the variable; instead, treat it like a ``contactfield``.
